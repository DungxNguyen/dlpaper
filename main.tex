...
\subsubsection{SSD}
This one is the fastest meta-architecture. SSD is more flexible~\alnote{what does flexible mean?} ~\dungnote{in Yolo you can not choose where you get the features, they are fixed in the network. In SSD you can choose whatever layers you want.}than YOLO because it uses prior boxes at different aspect ratio at different scale of feature map.~\cite{liu2016ssd}
...
~\cite{shen2018cs}~do an amazing job in English writing. :D
