...
DeepMultiBox is a box-generating model that becomes a basis for many other object deection architectures. Rather than a fully object detection model, it only predicts class-agnostic boxses with confident scores.
