...
\subsubsection{VGG}
VGG networks are stacks of multiple convolutional layers with max pooling layers, topped by 3 fully connected layer before producing output to a final softmax. Original variants of VGG are VGG16 and VGG19, which have in total 16 and 19 weighted layers respectively. VGG was the state-of-the-art model in image classification in 2014, but quickly become outdated.
